...
public class Solution extends SimpleFileVisitor<Path> {
    ...
    //Переопределенный метод во время обхода дерева при посещении файла,
    // в случае, если он является zip или rar архивом,
    // добавляет его адрес(file) в виде строки к списку архивных файлов;
    @Override
    ...
    //В случае неудачной попытки доступа к file,
