...
public class Solution {
    ...
    public static <T> void add(List<? super T> destinationList, List<? extends T> sourceList) {
        ListIterator<? super T> destListIterator = destinationList.listIterator(); //потребитель
        ListIterator<? extends T> srcListIterator = sourceList.listIterator(); //производитель
